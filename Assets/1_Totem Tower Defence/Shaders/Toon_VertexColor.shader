...
////// Emissive:
                ...
                float3 emissive = ((i.vertexColor.rgb*_Tint_var.rgb)*(_Palette_var.rgb+_PaletteIntensity_var)*lerp(float3(node_6989,node_6989,node_6989),_LightColor0.rgb,_LightColorIntensity_var)*lerp(node_6989,attenuation,_LightAttenuationIntensity_var));
