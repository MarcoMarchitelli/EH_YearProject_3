...
Shader "Shader Forge/Toon_Texture" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _ColorPalette; uniform float4 _ColorPalette_ST;
            UNITY_INSTANCING_BUFFER_START( Props )
...
////// Emissive:
                float4 _ColorPalette_var = tex2D(_ColorPalette,TRANSFORM_TEX(i.uv0, _ColorPalette));
                ...
                float3 emissive = ((_ColorPalette_var.rgb*_Tint_var.rgb)*(_LightingPalette_var.rgb+_LightingPaletteIntensity_var)*lerp(float3(node_6989,node_6989,node_6989),_LightColor0.rgb,_LightColorIntensity_var)*lerp(node_6989,attenuation,_LightAttenuationIntensity_var));
