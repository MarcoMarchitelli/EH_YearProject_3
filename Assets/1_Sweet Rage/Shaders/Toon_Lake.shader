...
Shader "Shader Forge/Toon_Lake" {
    Properties {
        ...
        _node_1197 ("node_1197", Range(-10, 10)) = 0.1549147
        _node_4630 ("node_4630", Color) = (1,1,1,1)
    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _node_1197)
                UNITY_DEFINE_INSTANCED_PROP( float4, _node_4630)
...
////// Emissive:
                ...
                float4 _node_4630_var = UNITY_ACCESS_INSTANCED_PROP( Props, _node_4630 );
                float _node_1197_var = UNITY_ACCESS_INSTANCED_PROP( Props, _node_1197 );
                float3 emissive = lerp(_node_4630_copy_var.rgb,_node_4630_var.rgb,saturate((sceneZ-partZ)/_node_1197_var));
