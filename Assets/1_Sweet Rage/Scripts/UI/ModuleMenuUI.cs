namespace SweetRage {
    ...
    public class ModuleMenuUI : MonoBehaviour {
        ...
        private void Update () {
            ...
            self.sizeDelta = Vector2.MoveTowards( self.sizeDelta, targetSize, Time.deltaTime * speed );
            ...
            while ( i <= count ) {
                ...
                element.anchoredPosition = Vector2.MoveTowards( element.anchoredPosition, targetPos, Time.deltaTime * speed );
                i++;
            }
        }
